...
public class BookResult {
     ...
     * @return
     */
    public static BookResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, BookResult.class);
            }
     ...
     * @return
     */
    public static BookResult format(String json) {
        try {
            return MAPPER.readValue(json, BookResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static BookResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
